...
*~ finish editing discussion within the word doc & copy back into Rmd *
*~ work out whether to edit abstract in word or Rmd *

~ see test_linenumbers.Rmd for how to get to word doc

~ add to intro couple of sentences about polygenic inheritance

~ about field data. 
We hope this can prompt more discussion about how best to combine empirical data and models of the evolution of insecticide resistance. 
...
~ think about submitting insecticide resistance outline to wikipedia
