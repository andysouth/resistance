...
oooo here there is a very nice shiny app demonstarting single locus selection :
...
~ work out order and how fitness translates to gamete frequencies

~ develop a graphic of the model

~ write the methods section model description for paper 2. It will help me get back in.
