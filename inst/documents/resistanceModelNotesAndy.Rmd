...
~ add cost figs as 4B and 9
~ for 4B I want cost 0,0.05,0.15
...
ideally I don't want to put cost into paper2. What justification can I have for that ? What justification did we use in paper1 ? Have other authors included costs in their models ?


but do my current cost things work properly for mix & sequences ? i.e. with cost you would expect freq. to decline in the sequence when first insecticide not being used.

~ ask Ian why he thought cost not important. Can I use this as a reason for not including cost in paper2 ?

~ ? setup a UI with cost
