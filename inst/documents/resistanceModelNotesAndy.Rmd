...
h & s & z in fitnessPrint() call of fitnessSingleLocus() need to be for both insecticides ?
dominance & selection coeff

With Ian & Matt
Can we clarify terminology on fitnessNiche etc.
...
~ check on travel claim for last visit to liverpool
~ add few hours for 25/7 fig production to my claim
...
show IVCC runUI5() to look at mosaics
at low effectiveness when seq is btter than mixture, a mosaic is also better than mixture.
increasing effectiveness (I1&2to 0.8) favours mixtures over sequences & mosaics.
...
at liverpool meeting :
~ ask Ian to go through my paper2
~ ask Ian about a strategy for approaching IVCC for further funding to make the model more useable, when can we do it, what can I do to help ? 
~ ask Ian to clarify the spatial scale issue in the mosaic runs
