...
```{r, eval=TRUE, echo=FALSE, fig.height=3.5} 
  ...
  #takes a long time to plot, initial version gave me count
  #I want it to plot the mean
  #check stackoverflow ..
    ...
    print( ggplot(ggSubset, aes(x=exposure, y=effectiveness_insecticide1 + effectiveness_insecticide2, colour=abs_diff))+
             ...
             geom_smooth(data=ggSubset[which(ggSubset$abs_diff==0),], method = "lm", se = FALSE) +
