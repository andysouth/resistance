...
1. what is xerror in tree$cptable it seems to be not constant between analyses ??? It is the cross validation parameter.

1. compare sequence/mixture tree with 0/1 for 1 of the chosen trees

1. is using the optimal error the way that susannah has suggested a problem ?
