...
Fig x2.. can we make the labels identical to those above i.e., in order  "Seq both"  "Mix 1st"  "Adaptive both "   "Mix both".... A reviewer will wonder why we don't do all 5 outputs described in Fig x1 i.e. whey we omit "Seq 1st"
...
1. add option to rescale x axis to years or months in plotcurtis_f2_generic, generation=1month
1. tidy these notes
