...
~ add default curtis values to UI labels in server.r
~ check on plotting of combined strategy
~ 

~ play with shiny app to help my understanding of how modifying the params alters results
