    ...
    if ( input$aButtonRunA >= 0 ) 
    {
      ...
      isolate({
        ...
        runcurtis_f2( max_gen = 500,
                      ...
                      #TODO what is the default dominance of cost
                      
                      z.RR1_00 = input$cost_A1,
                      z.RR2_00 = input$cost_A2,
                      
                      h.RS1_00 = input$domcost_A1,
                      h.RS2_00 = input$domcost_A2,
    ...
    if ( input$aButtonRunB >= 1 ) 
    {
      ...
      isolate({
        ...
        runcurtis_f2( max_gen = 500,
                      ...
                      z.RR1_00 = input$cost_B1,
                      z.RR2_00 = input$cost_B2,
