...
```{r, eval=TRUE, echo=FALSE, fig.height=3.5} 
  ...
  ggSubset$effectiveness_added <- ggSubset$effectiveness_insecticide1 + ggSubset$effectiveness_insecticide2
...
```{r, eval=TRUE, echo=FALSE, fig.height=3.5} 
  ...
  #names_inputs <- names(ggInsOuts)[1:num_inputs]
  names_inputs <- c("effectiveness_insecticide1", "effectiveness_insecticide2", "effectiveness_added")  
...
```{r, eval=TRUE, echo=FALSE, fig.height=3.5} 
  ...
  ggSubset$mix2_not20pc_better_seq0.5 <- ifelse( ggSubset$mix2_minus_seq0.5 / ggSubset$gen_cP0.5seq <= 0.2, 1, 0 )   
    ...
    library(viridis)
    print( ggplot(ggSubset, aes(x=exposure+exposure*male_exposure_prop, y=effectiveness_insecticide1 + effectiveness_insecticide2, colour=abs_mix2_minus_seq0.5))+
             ...
             theme_bw() +
             #add point for Curtis inputs
             geom_point(data = curtisInputs, aes(x=exposure+exposure*male_exposure_prop, y=effectiveness_insecticide1 + effectiveness_insecticide2), colour='red', shape=3) +
             ylab('effectiveness of insecticides added') +
