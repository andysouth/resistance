...
~ Ctrl A, Page layout, line nums, double space.
~ Insert, page number.
~ check that tables and other sections don't cross pages but do not use page breaks in your manuscript
~ modify any table column widths that need
~ delete figures


What did we say we would do for next meeting with IVCC ? Seems we didn't but we should prepare something.
...
I should submit figs as Tiff or Word (probably Tiff)

Maybe try to add ref. to this in to discussion somewhere. (& what were Roushes main recomendations for IRM ?) 
[@Roush1989] 
