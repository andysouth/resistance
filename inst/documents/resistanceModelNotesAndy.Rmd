...
Methods: population-genetic model of the spread of insecticide resistance in response to insecticides used either
as adulticides (ITNs) or as larvicides (malaria control or agriculture).

Results: 
We show that indoor use of insecticides leads to less selection
pressure than their use as larvicides. 

Reasons for relatively low selection pressure by adulticides
(i) males are not affected by the ITNs
(ii) insecticides are also repellents, keeping mosquitoes at bay from contacting the insecticide but also driving
them to bite either people who do not use the insecticide or alternative hosts.
...
~~ PAPER2
~ finalise 4 figure format in effectiveness_exposure_difference.Rmd
~ copy figure across
...
~ do some more stuff on paper2 text so it has clearer structure
...
~ claim for train 15/9/16

~ write down terminology on fitnessNiche etc. ideally within the documentation.
...
check out the github thing I saw on twitter about keeping uptodate with an upstream repository.
