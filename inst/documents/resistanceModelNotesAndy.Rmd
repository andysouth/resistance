...
~ be slightly careful seems 2 potential ways of getting sim inputs for the field data

~ run wos plots for the field data
~ need to pass field data mortalities to wos_sim()
~ wos_sim wants :
#' @param concs concentration or time
#' @param mort_rr rr mortalities
#' @param mort_sr sr mortalities
#' @param mort_ss ss mortalities
~ should be fairly easy to get these
~ aha yes I do it already in wos-plots from other data
~ indeed I calc some model inputs there ...
