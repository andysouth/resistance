...
**20/5/15** 11- in liverpool meeting with Beth and train back
...
1. try to stop man pages being tracked by git, thy ar already in git ignore but I think I may need to do git delete or something delete them from the repo to stop git from tracking them
