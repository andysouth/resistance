...
plot_fit_rs(df_base_, column='f', title='base', ylim=c(0.4,0.8))

plot_fit_rs(df_ef_, column='f', title='effectiveness', ylim=c(0.4,0.8), yblank=TRUE)

plot_fit_rs(df_ex_, column='f', title='exposure', ylim=c(0.4,0.8), yblank=TRUE)
