...
for(i in names_results)
{
  ...
  print( ggplot(ggSubset, aes_string(x='strategy',y=i, color='strategy')) + 
      ...
      scale_x_discrete("Resistance to which insecticide", limits=c("insecticide 1","Mixture 1","Sequential","Mixture 2","Mixture 3"), labels = c("insecticide 1"="Sole use", "Mixture 1"="1st in mix","Sequential"="2nd in sequence", "Mixture 2"="adaptive mix", "Mixture 3"="2nd in mix" ) )
...
## How difference in time-to-resistance between sequential and adaptive mixture is effected by input values
...
### Curtis' Fig 2. inputs : mix2 > combined > mix1 > seq
...
### decrease effectiveness of I2 from 1 to 0.85 : mix2 > combined > seq > mix1
```{r, eval=TRUE, echo=FALSE, fig.height=4}
...
### also decrease effectiveness of I1 from 0.73 to 0.63 : seq > mix2 > combined > mix1
```{r, eval=TRUE, echo=FALSE, fig.height=4}
