...
~ decide what to do with field data - perhaps mention cost & dominance calculations and how they make the pyr decline in freq. ?

~ Put the new input field data & runs into an Rmd on it's own to send to Ian.
done ~ Sort Fig  to go before fig1
