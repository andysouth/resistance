---
title: "pap1_figs_slimmed_50_unequal : all runs with high starting frequency of resistance to 1 insecticide"
output: pdf_document
...
```{r, eval=TRUE, echo=FALSE, fig.height=2.5} 
  ...
  #4unequal
  in_cols <- c("exposure","dominance_allele1","selection_coef_allele1","effectiveness_insecticide1") 
