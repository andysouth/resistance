...
insecticide_strategy_diagrams.ppt can be a good start for my slides for ASTMH

still seems to be something weird going on because LD plots are produced when I build the package ??

~ do some more stuff on paper2 text so it has clearer structure before ASTMH
...
create slides for ASTMH : 10 mins
keep the messages simple
introduce the basics. Ian will cover Curtis.
include my yellow/green slide about non-adaptive mixtures vs sequential ? 

add an adaptive mixture strategy to my slide ?


Maybe I should look back at Justins email of 14 September which contains a couple of trickyish scenarios we coud try to represent.

I'd like to do graphic of mixture/seq/mosaic, should I do in R or powerpoint ? ppt would be quicker and more flexible.

Ian said go and produce the graph for fig2 with both of Curtis' figs in.
...
Fig 1 add A) & B)
Fig 2 add A) & B) potentially add scans of Curtis figs
...
Annual meeting 13-17 November 2016, Atlanta.
