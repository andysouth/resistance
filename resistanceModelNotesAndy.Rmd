...
1. try to get some simple trees

1. decide how to format table of results
1. put some results together for Ian, not sure how to do trees
1. include a couple of contrasting graphs, to make a story. e.g. one where mixture better and one where sequential. Maybe number points on the figs.

1. it might be that the tyree results are not useful ??

1. sort order of insecticides for sequential figures
