...
#now try the same faceting by effectiveness_insecticide1
#doesn't really show much ...
#so why does effectiveness come out so important in the trees ??  
  #hist(ggInsOuts$effectiveness_insecticide1)  
  #create effect1 bins
  ggInsOuts$effect1_cat <- cut(ggInsOuts$effectiveness_insecticide1,breaks=c(0.4,0.6,0.8,1), labels=c("effect1 0.4-0.6","effect1 0.6-0.8","effect1 0.8-1"))    
