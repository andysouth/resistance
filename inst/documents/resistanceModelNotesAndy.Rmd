...
Curtis1985 (from Rawlings 1981) DDT & HCH (lindane an organochlorine )
...
** best so far: only has one resistance (kdr)

Can I combine data from Curtis1985 & Kolaczinski2000 

In Levick SI we show how we derive inputs.
Curtis1985
DDT fitness SS 0.27 RS 0.31 RR 0.5
HCH         SS 0    RS 0.07 RR 0.43
...
1. Effectiveness | 
2. Exposure | 
3. Resistance restoration  | 
4. Dominance of restoration | 
5. Frequency  | 
