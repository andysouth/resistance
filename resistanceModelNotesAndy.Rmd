...
1. work on sensiPostProc() It will need to be quite clever. It will take the output files from insecticide1, insecticide2 and mixture and use these to calculate timeToResistance critical points for sequential, mixture1 & mixture2 scenarios. Try to make it as modular as possible.
