...
What is the impact of adding nonpyrethroid IRS where LLINs are already deployed
...
could be adopted by other programmes.""
...
Checking Malaria j. proofs :

I need to improve refernces 32 & 34 :

32. Gressel J. Catch 22: All doses select for resistance. When will this happen
and how to slow evolution ? In: Pesticide dose: effects on the environment
and target and non-target organisms. Washington, DC: American
Chemical Society; 2017. p. 61–72.

DOI:10.1021/bk-2017-1249.ch005


34. Via S. Quantitative genetic models and the evolution of pesticide resistance.
In: Pesticide resistance. Strategies and tactics for management.
Washington, DC: National Academy Press; 1986. p. 222–35.

This is template example 
Wyllie AH, Kerr JFR, Currie AR. Cell death: the significance of apoptosis. In: Bourne GH, Danielli JF, Jeon KW, editors. International review of cytology. London: Academic; 1980. p. 251-306.

so seems I need to put editors in, but 2nd one doesn't name editors :


32. Gressel J. Catch 22: All doses select for resistance. When will this happen
and how to slow evolution ? In: Duke SO, Kudsk P, Solomon K, editors. Pesticide dose: effects on the environment and target and non-target organisms. Washington, DC: American
Chemical Society; 2017. p. 61–72.

34 doesn't have named editors, they are indicated as :
National Research Council; Board on Agriculture; Committee on Strategies for the Management of Pesticide Resistant Pest Populations. 
...
management plans, public health may have an advantage over agriculture.
Agricultural pest management is concerned with hundreds
of species, and in many cases, detailed data are not available for each
pest species (and potential nontarget organisms). Compared to agriculture,
public health is concerned with a small number of insect
...
currently known. 
GPIRM does highlight the success of a rotation-based
management strategy in one public health example: the West African
...
to use was not based on the detection of resistance, other than the initial
observation that control with a single insecticide was failing due to
resistance (Curtis et al., 1993).

The best strategy may be to use resistance monitoring to inform which insecticides
can be used in a rotation, but not when they should be used.
...
Efforts to develop long-lasting products for vector control might be counterproductive with regard to resistance management if the result is a long and shallow decay curve.
The ideal persistence profile from a resistance management perspective
needs to be balanced, however, with the need to provide continuous
protection from disease. A product with rapid decay could leave
people unprotected from disease if too much time elapses between treatments.

In public health, population growth does not necessarily translate to more disease transmission. For example, increasing densities of vector populations might
influence phenotypic traits that make better or worse disease vectors
(Moller-Jacobs, Murdock, & Thomas, 2014; Russell et al., 2011;
Shapiro, Murdock, Jacobs, Thomas, & Thomas, 2016).

To our knowledge, there is only one field trial aimed specifically at testing
...
either insecticide rotations or mosaics in slowing the spread of resistance
when compared to monotherapy. However, these results do not
...
in agriculture is the management of Bt resistance in genetically modified (GM) crop in the United States (Bates, Zhao, Roush, & Shelton, 2005; Tabashnik, Gassmann, Crowder, & Carriére, 2008; Tabashnik et al., 2003). This is a high-dose/ refuge strategy based on expression of high doses of Bt toxin within GM crops, combined with non-Bt refuges, which can be non-GM cotton or corn or even another plant used by the target pest. The high dose of Bt is designed to kill fully susceptible and heterozygote-resistant
insects. Any homozygote-resistant individuals will be initially rare, and there is a high probability that they will mate with the numerically dominant susceptible individuals emerging from the non-Bt refuge. These matings result in heterozygotes
that are functionally susceptible to the Bt crop, effectively
...
frequencies of resistance alleles, recessive inheritance of those resistance
...
~ have a go at modifying UI to replace dominance of cost with costRR and costSS (will probably need to recalc dominance) (or not for the paper ?)


~ see p1593 in Bourguet2000 Dwt dominance in presence of insecticide, Dwnt dominance in absence of insecticide

## to do for workshop
~ UI with costRR and costRS
~ prepare ppt (include field data table from paper2)
~ include both Fig2 and one other annotated Fig from paper2 in workshop handout 
~ remove shinyapps resistmob1
~ check how many hours & concurrent users I have on shinyapps
~ install resistance & rotations packages on Ians laptop
~ maybe provide instructions for running offline for R users (github install package, then runUI()) BUT I might want to first move some of resistance package - prob not too much hassle
