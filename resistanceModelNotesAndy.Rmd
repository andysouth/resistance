...
1. work on sensiPostProc() It will need to be quite clever. It will take the output files from insecticide1, insecticide2 and mixture and use these to calculate timeToResistance critical points for sequential, mixture1 & mixture2 scenarios.

1. do the output files from runModel2() have the input params attached or do I need to save inputs & outputs separately ? The latter may be a good plan to avoid having to rerun long simulations if I want to investigate outputs further later.

1. maybe rename sensiAnPaper1 to something more informative
