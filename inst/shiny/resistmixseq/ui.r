...
#shinyUI(fixedPage( theme = "bootstrap_simplex.css",
  ...
  fluidRow(
    ...
    column(1, offset = 0,
           ...
           sliderInput("domcost_A1", NULL, val=0.5, min = 0, max = 1, step = 0.1, ticks=FALSE),
           sliderInput("domcost_A2", NULL, val=0.5, min = 0, max = 1, step = 0.1, ticks=FALSE),
           hr(),
           sliderInput("domcost_B1", NULL, val=0.5, min = 0, max = 1, step = 0.1, ticks=FALSE),
           sliderInput("domcost_B2", NULL, val=0.5, min = 0, max = 1, step = 0.1, ticks=FALSE)
    )
