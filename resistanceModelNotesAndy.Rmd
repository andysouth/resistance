...
1. set 1000 runs to do tonight, rename outputs to 100
1. restart the project to clear environment
1. check carefully that the post-processing is doing what I think it is
