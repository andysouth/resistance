...
maybe similar to that in plotallele.freq.andy()

~ look at plotallele.freq.andy() for plotting responses to single insecticides
...
~ check why when correctMixDeployProp is set to 0 that the curve for the first insecticide is not the same for the insecticide in single use ?



~ we will need to talk about IP for the resistance modelling.
...
Days (/7.5)		16.6
Days previous 71
Days remaining (from 85)		71-16.6 = 54.4
