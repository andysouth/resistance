...
~ add a notes tab to the UI resistmixseq (can be after next submission)
~ check resistmixseq on phone
...
## to do for MJ paper
~ do I need to add plots for dominance of cost or remove it ?
~ maybe create new UI on shinyapps with better name, incl. cost, maybe costRR & costRS
...
~ check whether I have a UI with cost
...
~ send Sudo2017 to Ian
~ read Sternberg 2017
~ read Ocampo 2016
done ~ send Huijben2017 to IVCC including a quote saying how important this work is.

~ reaqaint myself with resistance code and improve documentation and testing
