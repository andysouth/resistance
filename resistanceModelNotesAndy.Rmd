...
~ check on plotting of combined strategy, i think I may not be doing it right

~ for the paper we could have a couple of figures that show how a relatively small change to effectiveness can alter the curtis plot.
