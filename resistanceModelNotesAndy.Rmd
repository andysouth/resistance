...
1. check on implementation of sexLinkage in randomMating()




1. think I can remove genotype.freq it is the same as f['m',], I might want to create an fstart[] outside of the generations loop. This was prompted because previously genotype.freq was the same for males and females and it adds an unecessary extra layer of potential confusion

1. further develop sex-linkage in randomMating(), allow option to be passed as arg, plus may need to look at calculating genotypes of both m&f in runModel2()
