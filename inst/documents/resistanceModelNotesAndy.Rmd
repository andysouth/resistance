...
~ replace model outline fig with one about how effectiveness etc. influence fitness
~ do I want to add cost of resistance to the paper ?
~ check mal journ, then remove any use of 1st person for malaria journal
