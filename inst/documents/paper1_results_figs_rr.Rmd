...
```{r, eval=FALSE,echo=FALSE,results='hide'}
  ...
  save(listOutMix, file=paste0(outFolder,'listOutMix_rr_1000.rda'))
  save(listOutI1, file=paste0(outFolder,'listOutI1_rr_1000.rda'))
  save(listOutI2, file=paste0(outFolder,'listOutI2_rr_1000.rda'))  
```  
...
```{r,echo=FALSE,results='hide'}
  ...
  load(file=paste0(outFolder,'listOutMix_rr_1000.rda'))
  load(file=paste0(outFolder,'listOutI1_rr_1000.rda'))
  load(file=paste0(outFolder,'listOutI2_rr_1000.rda'))
